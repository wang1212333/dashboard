...
export function registerWorkbenchTools(ctx: Context, library: KnowledgeLibrary): void {
  ctx.tools.register(defineTool({
    ...
    description: 'Save a complete HTML dashboard authored directly by the Agent. This is the native workflow: no predefined business template, field mapping, Plan, Spec, confirmation, or deterministic renderer is required. The Agent independently chooses the dashboard structure and implementation from the user request and data.',
    parameters: {
