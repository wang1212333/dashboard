...
export type DashboardStatus = 'draft' | 'preview' | 'released'

export interface DashboardManifest {
  assetId: string
  displayName: string
  source: { kind: 'csv'; label: string }
  templateId: string
  dataContract: DashboardDataContract
  /** User-confirmed source-column mapping for reproducible rebuilds. */
  fieldMapping?: Record<string, string | undefined>
  /** Confirmed, user-visible plan used to create this immutable revision. */
  spec?: DashboardSpec
  revision: string
