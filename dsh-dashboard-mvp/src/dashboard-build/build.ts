...
import type { ContentDashboardModel, DashboardBuildInput, DashboardBuildResult } from './contracts.js'
...
export interface BuildDashboardOptions extends DashboardBuildInput { mapping?: DashboardFieldMapping }
...
export function buildDashboardFromCsv(csv: string, options: BuildDashboardOptions = {}): DashboardBuildResult {
  ...
  return { html, quality, model, template }
}
